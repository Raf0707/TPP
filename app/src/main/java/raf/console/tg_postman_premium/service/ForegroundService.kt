package raf.console.tg_postman_premium.service
...
import raf.console.tg_postman_premium.R
import raf.console.tg_postman_premium.presentation.screens.DurationSubMode
import raf.console.tg_postman_premium.presentation.screens.SendMode
import raf.console.tg_postman_premium.presentation.screens.TelegramMessageType
...
class TelegramForegroundService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        serviceScope.launch {
            ...
            val intentResult = Intent("raf.console.tg_postman_premium.ACTION_SEND_COMPLETE").apply {
    ...
    private suspend fun sendMessagesOnce(
        ...
        chatIds.forEach { chatId ->
            ...
            localCount++
            val progressIntent = Intent("raf.console.tg_postman_premium.ACTION_SEND_PROGRESS").apply {
